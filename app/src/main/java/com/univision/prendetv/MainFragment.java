...
public class MainFragment extends BrowseFragment {
    ...
    public void displaySearchResults(final String searchTerm, final List<Movie> searchedMovies) {
        ...
        for(final Movie movie: searchedMovies) {
            listRowAdapter.add(movie);
        }

        final HeaderItem header = new HeaderItem(1, "Search Results");
        rowsAdapter.add(new ListRow(header, listRowAdapter));
