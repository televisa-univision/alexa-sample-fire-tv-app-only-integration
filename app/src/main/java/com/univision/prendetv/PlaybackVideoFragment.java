...
public class PlaybackVideoFragment extends VideoSupportFragment {
    ...
    private static final String TAG = PlaybackVideoFragment.class.getName();

    private PlaybackTransportControlGlue<MediaPlayerAdapter> mTransportControlGlue;

    public PlaybackTransportControlGlue getPlayer(){
        return mTransportControlGlue;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, MessageFormat.format("PlaybackVideoFragment called with movie {0}", movie));
